...
namespace TheDeep.Content.Tiles
{
    ...
    public class ZincOreSystem : ModSystem
    {
        public static LocalizedText ZincOrePassMessage { get; private set; }
        public static LocalizedText BlessedWithZincMessage { get; private set; }

        public override void SetStaticDefaults()
        {
            ZincOrePassMessage = Mod.GetLocalization($"WorldGen.{nameof(ZincOrePassMessage)}");
            BlessedWithZincMessage = Mod.GetLocalization($"WorldGen.{nameof(BlessedWithZincMessage)}");
        }
        ...
        public void BlessWorldWithZinc()
        {
            ...
            ThreadPool.QueueUserWorkItem(_ => {
                // Broadcast a message to notify the user.
                    Main.NewText(BlessedWithZincMessage.Value, 50, 255, 130);
                ...
                for (int iteration = 0; iteration < splotches; iteration++)
                {
                    ...
                    WorldGen.OreRunner(i, j, WorldGen.genRand.Next(6, 9), WorldGen.genRand.Next(6, 9), (ushort)ModContent.TileType<ZincOreTile>());
                }
            });
        }
        ...
        public override void ModifyWorldGenTasks(List<GenPass> tasks, ref double totalWeight)
        {
            ...
            if (ShiniesIndex != -1)
            {
                ...
                tasks.Insert(ShiniesIndex + 1, new ZincPass("TheDeep Zinc Ores", 237.4298f));
            }
        }
    }

    public class ZincPass : GenPass
    {
        public ZincPass(string name, float loadWeight) : base(name, loadWeight)
        {
        }
        ...
        protected override void ApplyPass(GenerationProgress progress, GameConfiguration configuration)
        {
            ...
            progress.Message = ZincOreSystem.ZincOrePassMessage.Value;
            ...
            for (int k = 0; k < (int)(Main.maxTilesX * Main.maxTilesY * 6E-05); k++)
            {
                ...
                WorldGen.TileRunner(x, y, WorldGen.genRand.Next(3, 6), WorldGen.genRand.Next(2, 6), ModContent.TileType<ZincOreTile>());
