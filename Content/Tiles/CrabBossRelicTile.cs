...
namespace TheDeep.Content.Tiles
{
    ...
    public class CrabBossRelicTile : ModTile
    {
        ...
        public virtual string RelicTextureName => "TheDeep/Content/Tiles/CrabBossRelic";

        // All relics use the same pedestal texture, this one is copied from vanilla
        public override string Texture => "TheDeep/Content/Tiles/RelicPedestal";
