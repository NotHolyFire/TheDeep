...
using TheDeep.Content.Projectiles.player.Tools;
...
namespace TheDeep.Content.Items.Tools
{
    ...
    public class BrassDrill : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<BrassDrillProjectile>(); // Create the drill projectile
            ...
            Item.tileBoost = -1;
            Item.pick = 100; // How strong the drill is, see https://terraria.wiki.gg/wiki/Pickaxe_power for a list of common values
        }

        public override void AddRecipes()
        {
            Recipe recipe = CreateRecipe();
            recipe.AddIngredient<BrassBar>(10);
            recipe.AddIngredient<CopperWire>(6);
            recipe.AddIngredient<ZincBattery>(2);
