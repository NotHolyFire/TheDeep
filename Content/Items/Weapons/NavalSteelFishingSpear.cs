...
namespace TheDeep.Content.Items.Weapons
{
    ...
    public class NavalSteelFishingSpear : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<NavalSteelFishingSpearProjectile>(); // The projectile that is fired from this weapon
        }
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient<NavalSteelBar>(6);
