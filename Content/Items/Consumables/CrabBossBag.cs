...
{
    public class CrabBossBag : ModItem
    {
        ...
        public override void ModifyItemLoot(ItemLoot itemLoot)
        {
            ...
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<krabby_patty>(), 1, 12, 16));
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<Shellshocker>(), 25));
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<Riptide>()));
            itemLoot.Add(ItemDropRule.CoinsBasedOnNPCValue(ModContent.NPCType<CrabBoss>()));
        }
