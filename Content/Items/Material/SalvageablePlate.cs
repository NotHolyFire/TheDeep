...
namespace TheDeep.Content.Items.Material
{
    ...
    public class SalvageablePlate : ModItem
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            ItemID.Sets.SortingPriorityMaterials[Item.type] = 33; // Influences the inventory sort order. 59 is PlatinumBar, higher is more valuable.
        }
    }
}
