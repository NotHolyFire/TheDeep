...
namespace TheDeep.Content.NPCs.Boss.CrabBoss
{
    ...
    public class CrabBoss : ModNPC
    {
        ...
        public override void ModifyNPCLoot(NPCLoot npcLoot)
        {
            ...
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<Shellshocker>()));
        ...
        public override void AI()
        {
            ...
            {
                Stamina = MaxStamina; // This is to stop from, after enraging, it to just have a lot of stamina even when un-enraged (?)
            }
