...
{
    public class MenuBeach : ModMenu
    {




        public override string DisplayName => "Observing the Tide";
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("TheDeep/Content/Assets/Background/ObservingTheTideMenu").Value;
