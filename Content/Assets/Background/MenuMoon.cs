...
{
    public class MenuMoon : ModMenu
    {




        public override string DisplayName => "The Grace before the Storm";
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("TheDeep/Content/Assets/Background/GraceBeforeTheStormMenu").Value;
