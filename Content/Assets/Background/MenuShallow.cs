...
namespace  TheDeep.Content.Assets.Background
{
    public class MenuShallow : ModMenu
    {




        public override string DisplayName => "Submerged in Shallow Waters";

        public override Asset<Texture2D> Logo => ModContent.Request<Texture2D>("TheDeep/Content/Assets/Background/SubmergedLogo");
        public override Asset<Texture2D> SunTexture => ModContent.Request<Texture2D>("TheDeep/Content/Assets/Background/noBG");
        public override Asset<Texture2D> MoonTexture => ModContent.Request<Texture2D>("TheDeep/Content/Assets/Background/noBG");

        public override int Music => MusicLoader.GetMusicSlot(Mod, "Content/Assets/Music/Shoneyy_ShallowWaters");
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("TheDeep/Content/Assets/Background/ShallowWatersMenu").Value;
