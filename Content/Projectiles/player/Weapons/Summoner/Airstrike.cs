...
namespace TheDeep.Content.Projectiles.player.Weapons.Summoner
{
    ...
    public class Airstrike : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.usesLocalNPCImmunity = true; // invincability per enimy if true if false every hit you do makes you unable to hit for a perioid of time
        ...
        public override void AI()
        {
            ...
            else
            {
                ...
                Projectile.velocity = Vector2.Lerp(Projectile.velocity, finalVelocity, 1f / 28f);
