...
namespace TheDeep.Content.Projectiles.player.Weapons.Summoner
{
    // basically just the example whip from example mod, i'll add new shit later
    public class CoastalCrashProjectile : ModProjectile
    {
        ...
        private bool Charge(Player owner)
        {
            ...
            Projectile.WhipSettings.RangeMultiplier += 1 / 90f;
        ...
        {
            target.AddBuff(ModContent.BuffType<CoastalWhipDebuff>(), 240);
            Main.player[Projectile.owner].MinionAttackTargetNPC = target.whoAmI;
            Projectile.damage = (int)(Projectile.damage * 0.7f); // decrease damage the more enemies it hits
        }
