...
{
    public class NavalSteelRapierParry : ModProjectile
    {
		...
		public override string Texture => "TheDeep/Content/Items/Weapons/Melee/Rapiers/NavalSteelRapier"; // Use texture of item as projectile texture
		...
		public override void SetDefaults() {
			...
			Projectile.height = 46; // Hitbox height of projectile
		...
		public override void AI() {
				...
				SoundEngine.PlaySound(new SoundStyle($"{nameof(TheDeep)}/Content/Assets/Sounds/Parry")
            {
				...
				for (int i = 0; i < 10; i++)
            	{
                	...
                	Dust.NewDustPerfect(target.Center, DustID.Torch, velocity * 2f, 0, default, 3f).noGravity = true;
            	}	
