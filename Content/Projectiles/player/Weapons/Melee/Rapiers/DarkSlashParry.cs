...
{
    public class DarkSlashParry : ModProjectile
    {
		...
		public override string Texture => "TheDeep/Content/Items/Weapons/Melee/Rapiers/DarkSlash"; // Use texture of item as projectile texture
		...
		public override void SetDefaults() {
			Projectile.width = 52; // Hitbox width of projectile
			Projectile.height = 52; // Hitbox height of projectile
		...
		public override void AI() {
				...
				SoundEngine.PlaySound(new SoundStyle($"{nameof(TheDeep)}/Content/Assets/Sounds/Parry")
            {
				...
				for (int i = 0; i < 10; i++)
            	{
                	...
                	Dust.NewDustPerfect(target.Center, DustID.Shadowflame, velocity * 2f, 0, default, 3f).noGravity = true;
            	}	
