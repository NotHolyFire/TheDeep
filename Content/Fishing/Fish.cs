...
namespace TheDeep.Content
{
    public class Fish : ModPlayer // https://tenor.com/view/fish-meme-you-know-what-that-means-gif-12503956388971591256
    {
        ...
        public override void CatchFish(FishingAttempt attempt, ref int itemDrop, ref int npcSpawn, ref AdvancedPopupRequest sonar, ref Vector2 sonarPosition)
        {
            ...
            {
                if (inWater && inForest && attempt.common)
            ...
            {
                if (inWater && inForest && attempt.uncommon)
            ...
            {
                if (inWater && inUnderground && attempt.rare)
            ...
            {
                if (inWater && inCaverns && attempt.uncommon)
            ...
            {
                if (inWater && inUnderground && attempt.uncommon)
            ...
            {
                if (inWater && inCaverns && attempt.common)
            ...
            {
                if (inWater && inBeach && whenRain && attempt.uncommon)
            ...
            {
                if (inWater && inTundra && whenRain && attempt.common)
            ...
            {
                if (inWater && inDesert && attempt.common)
            ...
            {
                if (inWater && inUndergroundDesert && attempt.uncommon)
            ...
            {
                if (inWater && inBeach && attempt.uncommon)
