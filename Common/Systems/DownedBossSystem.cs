...
namespace TheDeep.Common.Systems
{
    ...
    {
        public static bool downedCrabBoss = false;
        // public static bool downedOtherBoss = false;

        public override void ClearWorld()
        {
            downedCrabBoss = false;
        ...
        {
            downedCrabBoss = tag.ContainsKey("downedCrabBoss");
